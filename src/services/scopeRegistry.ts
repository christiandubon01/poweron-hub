...
export const SCOPE_REGISTRY: Readonly<Record<DataScope, ScopeDescriptor>> = {
  ...
  'fieldLogs.payments': {
    ...
    dataPath: 'serviceLogs[].collected/payments/statusEvents',
    owner: 'V15rFieldLogPanel',
    level: 'nested',
    identityField: 'service log id',
    needsTimestamp: true,
